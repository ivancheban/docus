...
![img](../assets/check-ruby-version.png)
...
![img](../assets/check-jekyll-version.png)
...
![img](../assets/path-to-project-folder.png)
...
![img](../assets/paste-path-command-prompt.png)
...
![img](../assets/gem-install-bundler.png)
...
![img](../assets/notepad-edit-gemfile.png)
...
![img](../assets/download-vscode.png)
...
![img](../assets/download-git-client.png)
...
![img](../assets/open-project-folder-vscode.png)

3. Open the project folder.

![img](../assets/open-project-folder.png)
...
![img](../assets/markdown-markup.png)
...
![img](../assets/project-your-repository.png)
...
![img](../assets/netlify-signup.png)

Or log in, if you already have an account.

2. Press the **New site from Git** button.

![img](../assets/new-site-from-git.png)

3. Select **GitHub** as your Git provider.

![img](../assets/connect-to-github.png)
...
![img](../assets/pick-repository.png)

6. Select **Deploy site**.

![img](../assets/deploy-settings.png)

You will see Netlify deploying your site with some funny name.

![img](../assets/deploy-progress.png)
